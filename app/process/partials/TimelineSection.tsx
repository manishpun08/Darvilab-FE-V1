      ...
      >
        ...
        <div className="mt-16">
          <div className="relative hidden md:block">
            <div
              className="absolute left-0 right-[10%] top-5 h-px bg-line"
              ...
              {processPhases.map((phase) => (
                ...
                >
                  <span className="relative h-10">
                    <span className="absolute left-0 top-3.75 h-2.5 w-2.5 rounded-full border border-dl-blue bg-dl-blue" />
                  </span>
