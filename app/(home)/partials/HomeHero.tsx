...
const statSvg = [
	...
	<path key="heart" d="M20.8 5.6a5.5 5.5 0 00-7.8 0L12 6.7l-1-1a5.5 5.5 0 00-7.8 7.8l1 1L12 22l7.8-7.8 1-1a5.5 5.5 0 000-7.7z" />,
];
		...
		>
			...
			>
				<div className="flex w-full max-w-[1400px] flex-col items-center justify-center px-2 pb-[clamp(44px,6vh,72px)] pt-[clamp(64px,9vh,112px)] text-center">
					...
					<div className="mt-[clamp(76px,10.5vh,108px)] flex w-full max-w-[980px] items-stretch justify-center max-md:flex-col max-md:gap-0">
