          ...
          >
            ...
            >
              <div className="absolute inset-0 flex items-center justify-end">
                <Image
                  alt="Darvilab office location on map"
                  aria-hidden="true"
              ...
              <Link
                href="https://maps.app.goo.gl/T58awniaS4Yw2bom6"
                target="_blank"
                rel="noopener noreferrer"
                className="absolute inset-0 z-30 cursor-pointer pointer-events-auto"
                aria-label="Open Darvilab location in Google Maps"
              />
            </div>
