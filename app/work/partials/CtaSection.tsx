...
export function CtaSection({
	...
	return (
		...
		>
			<div
				className={`${shell} grid grid-cols-[92px_1.3fr_.7fr] gap-[54px] py-[144px] max-lg:grid-cols-[56px_1fr] max-lg:gap-9 max-sm:grid-cols-1 max-sm:gap-6 max-sm:py-24`}
				ref={animRef}
				style={getFooterParallaxStyle(enableParallax)}
			>
				<div className="flex flex-col items-center border-r border-line max-sm:hidden" data-cta-item>
				...
				<div className="self-end max-lg:col-start-2 max-lg:max-w-[520px] max-sm:col-start-1 max-sm:max-w-none" data-cta-item>
