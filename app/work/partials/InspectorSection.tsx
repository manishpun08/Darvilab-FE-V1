...
import { useIntroReveal, useStatCounter } from "@/hooks/usePortfolioAnimations";
...
export function IntroSection({
  ...
  useStatCounter(sectionRef as React.RefObject<HTMLDivElement | null>);
	...
	return (
		<section
			className={`border-y border-line bg-white pt-[clamp(104px,11vw,176px)] pb-[clamp(72px,7vw,112px)] max-md:pb-3 ${
