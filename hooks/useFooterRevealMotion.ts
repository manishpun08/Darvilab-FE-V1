...
const MAX_TESTIMONIAL_SHIFT = 20;
const MAX_FOOTER_CONTENT_SHIFT = 32;
const MAX_FOOTER_DRIFT = 18;
const DRIFT_RESPONSE = 0.18;
const POSITION_SMOOTHING = 0.16;
const DRIFT_SMOOTHING = 0.22;
const DRIFT_RETURN = 0.92;
